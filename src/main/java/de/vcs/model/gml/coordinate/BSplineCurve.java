 ...
 * shall all be set to 1. A B-spline curve is a piecewise B�zier curve if it is
 ...
 * starting at 0.0. A piecewise B�zier curve that has only two knots, 0.0, and 1.0,
 * each of multiplicity (degree+1), is equivalent to a simple B�zier curve.
 * @author rruhdorfer
 * @version 1.0
 * @created 20-Nov-2019 15:50:17
 */
public class BSplineCurve extends SplineCurve {
